...
class File():
    def __init__(self):
        self.all = [{'Roll No': "1", 'Name': 'Arjun', 'Department': 'mca', 'Address': 'bhabhar'}, {'Roll No': "2", 'Name': 'vishal', 'Department': 'b.com', 'Address': 'deesa'}]
    ...
    def new_option(self,opt_range):
        try:
            ...
            if choice >=1 and choice <= opt_range:
                ...
                return self.new_option(opt_range)
        except:
            print("Enter Valid Choice!!")
            return self.new_option(opt_range)

    def add_student_1(self):
        global all
        global student
        def roll_validation():
            ...
            if roll.isalpha() != True:
                if roll.isdigit() == True:
                    ...
                    if roll not in roll_list:
                        ...
                        print("Roll no is already exist plese enter diffrent Roll No!!")
                        roll_validation()
                else:
                    print("Plese Enter RollNo in Digit!!")
                    roll_validation()
            else:
                print("Plese Enter RollNo in Digit!!")
                roll_validation()
    ...
    def delete_student_2(self):
        ...
        for j in all:
            if roll in roll_list:
                ...
                self.delete_student_2()


    def student_detail_3(self):
        roll = input("Enter your Roll No : ")
        roll_list = []
        ...
        for j in all:
            if roll in roll_list:
                ...
                print("Enter valid Roll No!!")
                self.student_detail_3()


    def update_student_4(self):
        roll = input("Enter your Roll No : ")
        if roll.isdigit() == True:
            roll_list = []
            ...
            for j in all:
                if roll in roll_list:
                    ...
                    print("Enter valid Roll No!!")
                    self.update_student_4()
        else:
            print("Enter valid Roll No!!")
            self.update_student_4()

    def display_all_student_5(self):
    ...
    def display_student_by_Roll_No_6(self,name):
        print("1)ASC","2)DESC",sep="\n")
        c = self.new_option(2)
        if c == 1:
            all.sort(key=itemgetter(name))
            self.display_all_student_5()
        elif c == 2:
            all.sort(key=itemgetter(name),reverse=True)
            self.display_all_student_5()


    def search_student_7(self,pera):
    ...
    def main(self):
        ...
        while True:
            ...
            if a == 1:
                ...
                b = self.new_option(4)
                if b == 1:
                    self.display_student_by_Roll_No_6("Roll No")
                elif b == 2:
                    self.display_student_by_Roll_No_6("Name")
                elif b == 3:
                    self.display_student_by_Roll_No_6("Department")
                elif b == 4:
                    self.display_student_by_Roll_No_6("Address")
            elif a == 7:
                print("1) Search by Roll No", "2) Search by Name","3) Search By Department", "4) Search by city",sep="\n")
                c = self.new_option(4)
                if c == 1:
                    self.search_student_7("Roll No")
                elif c == 2:
                    self.search_student_7("Name")
                elif c == 3:
                    self.search_student_7("Department")
                elif c == 4:
                    self.search_student_7("Address")
            elif a == 8:
                print("Thank you!")
                exit()
